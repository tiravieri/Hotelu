                        ...
                        <div class="white-box">
                            ...
                            <?php echo form_open_multipart('MKamar_C/inputKamar', 'class="form-horizontal form-material" runat="server"'); ?>
                                <div class="form-group">
                                    <label class="col-md-12">Penjelasan</label>
                                    <div class="col-md-12">
                                        <input type="text" name="penjelasan" placeholder="Penjelasan Kamar" class="form-control form-control-line"> 
                                    ...
                                    <tbody>
                                        <?php $i=0; foreach($data as $item){ $i++;?>
                                            <tr>
                                                ...
                                                <td><?php echo $item->penjelasan?></td>
                                                <td><?php echo $item->status?></td>
                                                <td>Rp <?php echo $item->harga?></td>
                                                <td><a class="btn btn-danger" title="Hapus Data" onclick="return confirmed('<?php echo site_url('MKamar_C/delete/'.$item->id_kamar)?>')"><i class="fa fa-trash-o"></i></a></td>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <?php echo form_open_multipart('MKamar_C/update/'.$item->id_kamar, 'class="form-horizontal form-material" runat="server"'); ?>
                                            <div class="col-md-12" style="margin-top:5%">
                                                <div>
                                                    <h4>Keterangan</h4>
                                                    <input  class="form-control select2" type="text" name="penjelasan" value="<?php echo $item->penjelasan?>" style=" width: 100%;">
                                                </div>
                                                <div>
                                                    <h4>Tipe Kamar</h4>
                                                    <select class="form-control form-control-line" name="tipe">
